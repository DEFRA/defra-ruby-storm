...
RSpec.describe DefraRuby::Storm::ResumeCallRecordingService do
  describe "#run" do
    ...
    context "when the request is invalid" do
      ...
      context "when invalid agent_user_id is passed" do
        ...
        it "raises an error" do
          expect { described_class.run(agent_user_id: "invalid_agent_user_id") }.to raise_error("Failed to resume call recording for agent_user_id: invalid_agent_user_id")
        end
      end
